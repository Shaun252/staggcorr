...
def tieup3pt_fullProp(prop1, prop2, prop3, mom1, mom2, mom3, phase1, phase2, phase3, shift1, shift2, shift3, dag1, dag2, dag3, vol, SUN=3):
    ...
    prop3 = apply_shift_bd_and_phase(prop=prop3, coord_iso_dict_l=coord_iso_dict1, coord_iso_dict_r=coord_iso_dict3,
                                     bd_dict_l = shift_bd_dict1, bd_dict_r = shift_bd_dict3,
                                     no_terms_l = no_terms1, no_terms_r = no_terms3,
                                     dag_l = dag1, dag_r = dag3,
                                     phase_l = phase_mom_arr1, phase_r = phase_mom_arr3,
                                     matrix_dim=matrix_dim)
    ...
    for timej in temporal_range:
        ...
        firstSpatialSumPhaseMom1 = prop3[:,lowerbnd:upperbnd] @ prop2[lowerbnd:upperbnd,:]
        
        for timek in temporal_range:
            lowerbnd = timek * spatial_dim
            upperbnd = (timek+1) * spatial_dim

            secondSpatialSumPhaseMom1 = firstSpatialSumPhaseMom1[:,lowerbnd:upperbnd] @ prop1[lowerbnd:upperbnd,:] 
